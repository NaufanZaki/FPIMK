...
const FadeIn: FC<FadeInProps> = ({
	...
	return (
		<div
			ref={ref}
			className={`${className} transition-all ease-in-out duration-1000 ${delayClass} ${
				isVisible
					...
					<div className="flex flex-col sm:flex-row lg:flex-col gap-3">
						{(Object.keys(servicesData) as ServiceKey[]).map((key) => (
							<button
								...
								className={`w-full p-4 sm:p-6 rounded-xl text-left transition-all duration-300 border-2 ${
									activeTab === key
							...
							>
								<div className="flex items-center flex-wrap gap-3 sm:gap-4">
									<div
										className={`${
											activeTab === key ? "text-cyan-400" : "text-gray-400"
										}`}
									>
...
const Testimonials: FC = () => {
	const testimonialsData = [
		{
			quote:
				"INOVYTE mengubah ide lomba kami menjadi MVP yang fungsional dan impresif. Dukungan teknis mereka sangat berharga. Berkat mereka, tim kami meraih juara pertama!",
			name: "Andi Pratama",
		...
		{
			quote:
				"Website baru dari INOVYTE benar-benar meningkatkan citra brand kami. Prosesnya kolaboratif dan hasilnya melebihi ekspektasi. Penjualan online meningkat 40%!",
			name: "Rina Setyawati",
							...
							<div className="flex flex-col h-full">
								...
								<div className="flex items-center mt-auto">
									<img
										...
										onError={(e) => {
											e.currentTarget.src =
												"https://placehold.co/100x100/1E293B/FFFFFF?text=Err";
										}}
									/>
									<div>
